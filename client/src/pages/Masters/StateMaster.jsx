...
const StateMaster = () => {
  ...
  {currentStates.map((state, index) => (
      ...
      >
        ...
        <div>
          <span className="sm:hidden font-medium text-gray-500 dark:text-gray-400">Status: </span>
          <span
        ...
        <div>
          <span className="sm:hidden font-medium text-gray-500 dark:text-gray-400">Action: </span>
          <button
