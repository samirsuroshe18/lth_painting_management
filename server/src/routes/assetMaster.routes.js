...
import { addNewAsset, getAllAssets, getAssets, getAssetsByLocation, getQrCodes, removeAsset, reviewAssetStatus, updateAsset, viewAsset, viewAssetPublic } from "../controllers/assetMaster.controller.js";
...
router.route('/get-all-assets').get(verifyJwt, checkAccess('assetMaster:view'), getAllAssets)
